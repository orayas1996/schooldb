...
<h2>เพิ่มข้อมูลวิชา</h2>
  ...
  <center>
	...
	<table class="table table-striped">
		<tr>
			<td>SubjectID : </td>
			<td><input class="form-control"  type="text" name="id" placeholder="2-CAPchars and 3-digits eg.MA101" required></td>
		</tr>
		<tr>
			<td>Name : </td>
		...
		<tr>
			<td>Year : </td>
			<td><input class="form-control"  type="number" name="year" placeholder="1-digit eg.1"></td>
		</tr>
		<tr>
			<td>Teacher : </td>
