...
<table class="table table-striped">
  ...
  <tr>
	...
	<form action='/bk/student/<?php echo $id; ?>/<?php echo($scid);?>/editscoresave' method="post">
		<tr>
			<td width="120" align="right" valign="middle">New_score:</td>
			<td><input class="form-control" type="text" name="newscore" placeholder="old score = {{$total}}"></td>
		</tr>
	</table><br>
		<center>
		<tr>
